...
function BuildTeam() {
  return (
    <div className="bg-gray-100 p-16 flex justify-center">
      <div className="max-w-[1500px]  flex flex-col items-center justify-center gap-7 md:flex-row">
        <div className="w-1/2">
          <div className="mb-16">
        ...
        <div className="w-1/2 2xl:w-1/4  hidden lg:block">
          <div className="flex flex-col 2xl:items-start">
            <div className="bg-white w-60 border relative top-52 left-7 shadow-2xl">
              <img src={person1} alt="" />
              <div className="p-3">
            ...
            <div className="bg-white w-60 border relative left-64 top-4 shadow-2xl z-10">
              <img src={person2} alt="" />
              <div className="p-3">
                <h3 className="text-blue-700 font-semibold hover:cursor-pointer hover:underline p-1">
                  Gabriel Courtemanche
            ...
            <div className="bg-white w-60 border relative bottom-10 left-20 shadow-2xl z-0">
              <img src={person3} alt="" />
              <div className="p-3">
                <h3 className="text-blue-700 font-semibold hover:cursor-pointer hover:underline p-1">
                  Gabriel Courtemanche
